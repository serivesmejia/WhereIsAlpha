...
var app = (function () {
    ...
    */
    ...
    function createScene(canvas) {
      ...
      // earth geometry
      const earthGeometry = new SphereGeometry(0.6, 32, 32);
      ...
      // cloud Geometry
      const cloudGeometry = new SphereGeometry(0.63, 32, 32);
      ...
      // cloud mesh
      const cloudMesh = new Mesh(cloudGeometry, cloudMetarial);
      scene.add(cloudMesh);
      ...
      // point light helper
      new PointLightHelper(pointLight);
      // scene.add(Helper);
    ...
    /* src\globe\Globe.svelte generated by Svelte v3.50.0 */
    const file$1 = "src\\globe\\Globe.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas, file$1, 11, 0, 188);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, createScene, el });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(globe, body, null);
    			current = true;
    		},
    		p: noop,
